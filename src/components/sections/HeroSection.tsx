...
const HeroSection = () => {
    ...
    return (
        // --- FIXED: Removed `overflow-hidden` to make the scroll indicator visible ---
        <section className="relative min-h-screen flex items-center justify-center">
            ...
            <div className="relative z-20 w-full">
                <div className="max-w-6xl mx-auto px-4 space-y-8">
                    ...
                    {/* Feature Pills - Horizontally scrollable on mobile, wraps on desktop */}
                    <div className="flex gap-3 md:gap-4 pt-6 overflow-x-auto md:flex-wrap md:justify-center md:overflow-x-visible pb-4 md:pb-0">
                        {[
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 pt-10">
                        {[
                            ...
                            <div
                                key={index}
                                className="bg-white/5 backdrop-blur-lg rounded-2xl px-8 py-4 hover:bg-white/10 transition-all w-full max-w-xs md:w-auto"
                            >
                    ...
                    <div className="hidden md:block text-center pt-6">
