...
const BalconyPromoSection = () => {
  ...
  const availableDate = new Date(2025, 8, 15); // September 15, 2025

  const openWhatsApp = () => {
    const message = `Hi! I'm interested in booking the "Balcony Room", available from September 15th. Could you provide more details?`;
